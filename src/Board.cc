...
Board::Board (MainWindow &win) : selected_x (-1),
                                 selected_y (-1),
                                 m_step (0),
                                 ...
                                 parent (win), red_time (2400), black_time (2400), play_time (40), step_time (240), count_time (0), limit_count_time (240), chessman_width (29), is_small_board (true), is_rev_board (false), m_search_depth (8), m_usebook (true), m_human_black (false), theme ("wood"), color ("#198964")
{
...
void Board::draw_bg (Cairo::RefPtr<Cairo::Context> &cr)
{
    ...
    pattern->set_extend(Cairo::Extend::EXTEND_REPEAT); // THIS IS THE IMPORTANT BIT!
                                                       //
    //cr->save();
